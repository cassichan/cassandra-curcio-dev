		...
		<section className="text-gray-600 body-font">
			<div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
				...
				<div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
					...
					<p className="mb-8 leading-relaxed font-medium text-gray-300">Software Engineer with a background in Healthcare and Project Management 👩‍💻 </p>
					<p className="mb-8 leading-relaxed font-medium text-gray-300">I am looking for my next career opportunity so please reach out to see how I can help your team!</p>
