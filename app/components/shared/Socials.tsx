		...
		<div className="flex mt-8">
			...
			>
				<Image
					...
					alt="github logo"
					src="/../public/static/socials/github-mark-white.png"
					height={30}
					width={55}
				/>
			</a>
			...
			>
				<Image
					...
					alt="linked-in logo"
					src="/../public/static/socials/medium.png"
					height={30}
					width={55}
				/>
			</a>
			...
			>
				<Image
					...
					alt="linked-in logo"
					src="/../public/static/socials/ln-white-1.png"
					height={30}
					width={55}
				/>
			</a>
			...
			>
				<Image
					...
					alt="email icon"
					src="/../public/static/socials/email-white.png"
					height={30}
					width={55}
				/>
			</a>
