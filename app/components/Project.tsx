...
export default function Project({ project }: ProjectProps) {
	return (
		<div className="xl:w-1/4 md:w-1/2 p-4">
			<div className="bg-gray-100 p-6 rounded-lg min-h-full hover:scale-105 flex flex-col">
				<Image
					className="flex h-120 rounded w-full object-cover object-center mb-6"
				...
				<div className="h-96">
					...
					<br />
					<p className="leading-relaxed text-base text-sm">{project.tech}</p>
				</div>
				<div className="flex">
					{project.github_url ? (
						<a
